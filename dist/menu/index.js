...
// module
exports.push([module.i, ".react-menu{padding:0;margin:0;font-size:14px;list-style:none;outline:none;box-shadow:0 2px 8px rgba(0,0,0,.15)}.react-menu:after,.react-menu:before{content:\" \";display:table}.react-menu:after{clear:both;visibility:hidden;font-size:0;height:0}.react-menu-submenu>.react-menu{border-radius:4px}.react-menu-sub-popup{background-color:#fff}.react-menu-sub-popup .react-menu-item{line-height:1.5;padding:5px 12px}.react-menu-hidden{display:none}.react-menu-horizontal .react-menu-item,.react-menu-horizontal .react-menu-submenu{float:left}.react-menu-horizontal:after{content:\" \";display:block;height:0;clear:both}.react-menu-item,.react-menu-submenu-title{padding:0 20px;cursor:pointer;outline:none;user-select:none}.react-menu-item a,.react-menu-submenu-title a{color:inherit;text-decoration:none}.react-menu-item-active{color:hsla(0,0%,100%,.9)}.react-menu-item-selected{background-color:#1890ff}.react-menu-sub-popup{position:absolute}", ""]);
